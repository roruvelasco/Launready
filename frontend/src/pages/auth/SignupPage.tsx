import { Shirt, ShieldCheck, Eye, EyeOff, ArrowLeft, User } from "lucide-react";
...
function IconInput({
  ...
  return (
    <div
      className={`flex items-center h-12 border border-gray-200 mt-4 bg-white rounded-md relative ${className}`}
    >
...
const SignupPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full mt-2 md:mt-0 md:px-20">
      {/* Navigation Bar with Back Button */}
      <nav className="sticky top-0 z-50 py-4 backdrop-blur-lg flex items-center">
        <button
          className="flex items-center gap-2 text-blue-500 hover:text-blue-700 transition-colors font-medium ml-8"
      ...
      <div className="flex justify-center items-center w-full flex-1 py-8 md:px-10 lg:px-24">
        <div className="flex w-full max-w-[120rem] justify-between border rounded-2xl border-neutral-100 shadow-2xl">
          {/* LEFT SIDE */}
          <div className="w-full lg:w-1/2 flex flex-col px-8 md:px-16 lg:px-24 py-2 bg-white rounded-l-2xl rounded-r-2xl">
            ...
            <p className="text-black opacity-60 mt-3">
              Welcome to Launready! Please choose a method to create your
              account.
            </p>
            ...
            <button className="bg-blue-500 text-white w-full py-3 rounded-md mt-5 mb-5 text-xl hover:bg-blue-600 transition-colors shadow hover:shadow-lg">
              Create
            </button>
          </div>
